...
export const projects: Project[] = [
  ...
  },
  {
    ...
    expandedContent: {
      ...
      images: ['soccer-tool-interface.png'],
      links: []
    }
  },
  {
    ...
    expandedContent: {
      ...
      images: ['fenton-3d-scene.png'],
      links: [
        { text: 'Visit Site', url: 'https://fenton.band' },
        { text: 'GitHub', url: 'https://github.com/nickmcmillan/fenton' }
      ]
    }
  }
];